...
return ( <section className="mb-14"> <div className="mb-5 flex items-end justify-between gap-4"> <div> <div className="flex items-center gap-3"> <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-black text-white"> <ShoppingBag size={18} /> </div>
...
return ( <header className="mb-10"> <Link
     href="/dashboard"
...
return ( <div className="mb-8 grid grid-cols-2 gap-3 lg:grid-cols-4">
{cards.map((card) => {
...
return ( <div className="flex min-w-0 flex-1 items-center gap-3 rounded-2xl bg-neutral-50 p-2.5"> <div className="h-14 w-14 shrink-0 overflow-hidden rounded-xl bg-white">
{image ? (
<img
...
/>
) : ( <div className="flex h-full w-full items-center justify-center text-neutral-300"> <Package size={18} /> </div>
)} </div>
...
return ( <article className="overflow-hidden rounded-3xl border border-neutral-200 bg-white transition hover:border-neutral-300 hover:shadow-[0_15px_45px_rgba(0,0,0,0.05)]">
{/* Header */} <div className="border-b border-neutral-100 p-5 sm:p-6"> <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between"> <div> <div className="flex flex-wrap items-center gap-2"> <span className="rounded-lg bg-black px-2.5 py-1 text-[10px] font-bold text-white">
#{order.id} </span>
...
return ( <div className="rounded-3xl border border-dashed border-neutral-200 bg-neutral-50 px-6 py-20 text-center"> <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-sm"> <Package
       size={25}
...
return ( <div className="rounded-3xl border border-neutral-200 bg-neutral-50 px-6 py-20 text-center"> <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white shadow-sm"> <XCircle
       size={22}
       className="text-neutral-400"
     /> </div>
...
return ( <main
 ...
 > <div className="mx-auto max-w-6xl px-5 py-8 sm:px-6 lg:px-8"> <PageHeader
